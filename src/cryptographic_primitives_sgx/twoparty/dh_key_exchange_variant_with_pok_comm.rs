...
use crate::cryptographic_primitives_sgx::commitments::hash_commitment::HashCommitment;
...
use crate::cryptographic_primitives_sgx::proofs::ProofError;
...
#[cfg(test)]
mod tests {
    use crate::cryptographic_primitives_sgx::twoparty::dh_key_exchange_variant_with_pok_comm::*;
